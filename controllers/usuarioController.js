...
import { uploadImageUsuarios } from "../helper/cloudinary.js";
...
const registrar = async (req, res) => {
    ...
    const {identificacion, nombre, email, password, telefono,} = req.body;
    let image;
    ...
    try {
        if (req.files.image) {
          const result = await uploadImageUsuarios(req.files.image.tempFilePath);
        ...
        const usuario = new Usuario({identificacion, nombre, email, password, telefono});
